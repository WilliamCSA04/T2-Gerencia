...
public class Conexao {
    ...
    private ArrayList<String> listaAgentes = new ArrayList<>();
    private ArrayList<Point> lista = new ArrayList<>();
    ...
    public void atualizaGrafico(String titulo, int inX, int inY, int outX, int outY) {
        if (anteriorIn != -1 && anteriorOut != -1) {
            ...
            lista.add(new Point(inX, (atualIn - anteriorIn), outX, (atualOut - anteriorOut)));
    ...
    public void atualizaGrafico(String titulo, int x, float y) {
        if (anteriorY != -1) {
            ...
            lista.add(new Point(x, (atualY - anteriorY)));
